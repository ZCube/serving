...
type PodAutoscalerInterface interface {
	Create(ctx context.Context, *v1alpha1.PodAutoscaler) (*v1alpha1.PodAutoscaler, error)
	Update(ctx context.Context, *v1alpha1.PodAutoscaler) (*v1alpha1.PodAutoscaler, error)
	UpdateStatus(ctx context.Context, *v1alpha1.PodAutoscaler) (*v1alpha1.PodAutoscaler, error)
	Delete(ctx context.Context, name string, options *v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1alpha1.PodAutoscaler, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.PodAutoscalerList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PodAutoscaler, err error)
...
func (c *podAutoscalers) Create(ctx context.Context, podAutoscaler *v1alpha1.PodAutoscaler) (result *v1alpha1.PodAutoscaler, err error) {
	result = &v1alpha1.PodAutoscaler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("podautoscalers").
...
func (c *podAutoscalers) Update(ctx context.Context, podAutoscaler *v1alpha1.PodAutoscaler) (result *v1alpha1.PodAutoscaler, err error) {
	result = &v1alpha1.PodAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podautoscalers").
...
func (c *podAutoscalers) UpdateStatus(ctx context.Context, podAutoscaler *v1alpha1.PodAutoscaler) (result *v1alpha1.PodAutoscaler, err error) {
	result = &v1alpha1.PodAutoscaler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podautoscalers").
...
func (c *podAutoscalers) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
...
func (c *podAutoscalers) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *podAutoscalers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PodAutoscaler, err error) {
	result = &v1alpha1.PodAutoscaler{}
